...
export const SliderMobile: React.FC<React.HTMLAttributes<HTMLDivElement>> = props => {
        ...
        for (let i = 0; i < totalSlides; i++) {
            buttons.push(
                <button aria-label={`${i + 1}`}
                    key={i}
                    className={classNames( `bg-white-default w-[10px] h-[10px] rounded-[50%] opacity-20`, currentSlide === i && '!opacity-100')}
