  ...
  return (
    <section className="max-w-[1200px] w-full mx-auto flex flex-col text-custom-black mt-[80px]">
      ...
      <div className="grid grid-cols-2 justify-between mb-[60px] gap-[20px]">
        ...
        <div>
          <div className='bg-white-default flex flex-col max-w-[589px] min-h-[651px] w-full p-10 gap-[30px] rounded-[25px]'>
          ...
          <ul className="flex flex-col flex-wrap gap-[15px] max-h-[160px] font-semibold">
            {medicalDireactions.map((direction) => (
              <li className="max-w-[250px]" key={direction.id}>
                <Link
                  href={direction.link}
                  className="text-[21px] underline text-custom-black break-words">
        ...
        <div className="max-w-[589px] w-full">
          <div className="flex flex-col p-10 gap-[30px] bg-white-default rounded-[25px]">
          ...
          <div className="bg-white-default rounded-[25px] p-10 mt-[20px] box-border">
            <DropDown
